...
<?php $nav_current = 'api'; include __DIR__ . '/nav.php'; ?>
        ...
        <div id="main">
            ...
            <br/>
            <span>Request testnet coins programmatically &mdash; for CI, integration tests, and tooling. Free, keyless, and rate-limited. The coins have no value.</span>

            <div class="card">
                <div class="card-header"><b>Prefill links (no integration)</b></div>
                <div class="card-body">
                    <p>Just sending a person here, say from a wallet's "get testnet coins" button? Link them to a faucet page with their address in <code class="mono">?address=</code> and the claim box arrives pre-filled &mdash; they solve the captcha and click. No integration, just an <code class="mono">&lt;a href&gt;</code>:</p>
...
<?php } ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p style="margin-top: 10px;">Success: <code class="mono">{"ok":true,"network":"&hellip;","amount":"&hellip;","txid":"&hellip;"}</code>.</p>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>Failures are <code class="mono">{"ok":false,"error":"&lt;code&gt;","message":"&hellip;"}</code> with a matching HTTP status:</p>
                    <table style="border-collapse: collapse; width: 100%; margin-top: 6px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul>
                        <li>One claim per <b>address</b> per claim window (shared with the website &mdash; claiming on the site and via the API count together).</li>
                    ...
                    <p>These are valueless testnet coins &mdash; please don't hammer or hoard. A <code class="mono">429</code> means wait (respect <code class="mono">Retry-After</code>), not retry-in-a-loop.</p>
                </div>
            </div>
